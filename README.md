# Система управления KPI сотрудников центра ИИ

Веб-приложение для управления ключевыми показателями эффективности (KPI) сотрудников. Позволяет вводить, отслеживать, утверждать показатели, генерировать отчёты и персональные рекомендации.
