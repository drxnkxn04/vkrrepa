<template>
  ...
  .login-box { padding: 40px; background: white; border-radius: 8px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); width: 100%; max-width: 400px; }
  ...
  .error-message { color: #d93025; text-align: center; margin-top: 10px; }
  </style>
